...
% GitHub - no line numbers
\lstdefinestyle{github-no-linum}{
  numbers          = none,
  linewidth        = \linewidth,
  xleftmargin      = 0em,
...
\lstset{style=github, float, caption=\lstname}
...
\lstdefinelanguage{json}{
        ...
        string=[s]{"}{"},
        literate=
        *{0}{{{\color{listing-numbers}0}}}{1}
        {1}{{{\color{listing-numbers}1}}}{1}
        {2}{{{\color{listing-numbers}2}}}{1}
        {3}{{{\color{listing-numbers}3}}}{1}
        {4}{{{\color{listing-numbers}4}}}{1}
        {5}{{{\color{listing-numbers}5}}}{1}
        {6}{{{\color{listing-numbers}6}}}{1}
        {7}{{{\color{listing-numbers}7}}}{1}
        {8}{{{\color{listing-numbers}8}}}{1}
        {9}{{{\color{listing-numbers}9}}}{1}
        % Uncomment these to color punctuation
        % {:}{{{\color{listing-keyword}{:}}}}{1}
        % {,}{{{\color{listing-keyword}{,}}}}{1}
        % {\{}{{{\color{listing-keyword-3}{\{}}}}{1}
        % {\}}{{{\color{listing-keyword-3}{\}}}}}{1}
        % {[}{{{\color{listing-keyword-3}{[}}}}{1}
        % {]}{{{\color{listing-keyword-3}{]}}}}{1},
}
